...
0<c.scrollingSpeed).css(X(e)),setTimeout(function(){s()},c.scrollingSpeed,c.easing)):f.animate({scrollLeft:e.left},c.scrollingSpeed,c.easing,function(){s()});n.find(".active").removeClass("active");n.find("li").eq(h).find("a").addClass("active")}function Y(){K?"text"!==a(document.activeElement).attr("type")&&a.fn.fullpage.reBuild(!0):(clearTimeout(Z),Z=setTimeout(function(){a.fn.fullpage.reBuild(!0)},500))}function ia(b,c){if(825>b||900>c){var e=Math.min(100*b/1024,100*c/576).toFixed(2);a("body").css("font-size",
